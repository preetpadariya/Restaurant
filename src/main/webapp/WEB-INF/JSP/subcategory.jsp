    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="city-details-data">
                ...
                <div class="m-4">
                    <a href="/admin-dashboard/add-subcategory"><div class="btn btn-info">Add SubCategory</div></a>
                </div>
                <div class="table">
                    <table>
                        <thead>
                        <tr>
                            ...
                            <th class="city-name" scope="col">Category Name</th>
                            <th class="name" scope="col">SubCategory Name</th>
                            <th class="des" scope="col">SubCategory Description</th>
                        ...
                        <c:forEach items="${subcategory}" var="subcategory" varStatus="loop">
                            <tr>
                                ...
                                <td>
                                    <a href="/admin-dashboard/subcategory/${subcategory.id}/edit" class="btn" type="button" style="background: #b1b4dc">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="/admin-dashboard/subcategory/${subcategory.id}/delete" class="btn btn-danger" type="button">
...
<%--                            <c:if test="${pageNo > 0}">--%>
<%--                                <li class="page-item">--%>
<%--                                    <a class="page-link" href="/category?pageNo=${pageNo - 1}&pageSize=${pageSize}" aria-label="Previous">--%>
...
<%--                                <li class="page-item">--%>
<%--                                    <a class="page-link" href="/category?pageNo=${pageNo + 1}&pageSize=${pageSize}" aria-label="Next">--%>
