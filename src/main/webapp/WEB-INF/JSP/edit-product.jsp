    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="add-city-container">
                ...
                <form class="add-city-form form" action="/restaurant-dashboard/product/${product.id}/edit/add" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="number" class="form-control" id="productPrice" name="productPrice" placeholder="Product Price" value="${product.price}" required>
                    </div>
                    <div class="form-group mb-5">
                        <label for="productDesc">Product Description</label>
                            <textarea class="form-control"  id="productDesc" name="productDesc" rows="2" placeholder="Description" required>${product.description}</textarea>
                    </div>
                    <div class="form-group mb-5">
