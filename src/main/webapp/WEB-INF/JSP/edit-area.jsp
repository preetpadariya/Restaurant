    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="add-city-container">
                ...
                <form class="add-city-form form" action="/admin-dashboard/edit-area/${area.id}/add" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-5">
                        ...
                        <select class="form-select" id="cityId" name="cityId" aria-label="Select City" required>
                            ...
                            <c:forEach items="${cities}" var="city">
                                <c:choose>
                                    <c:when test="${city.id == area.city.id}">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="text" class="form-control" id="cityName" name="cityName" aria-describedby="emailHelp" placeholder="City Name" value="${area.name}" required>
                    </div>
                    <div class="form-group mb-5">
                        <label for="cityDesc">Area Description</label>
                        <div id="">
                            <textarea class="form-control"  id="cityDesc" name="cityDesc" rows="3" placeholder="Description" required>${area.description}</textarea>
                        </div>
                    </div>
