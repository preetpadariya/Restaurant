    ...
    <section class="side-bar">
        <div class="list">
            <ul>
                ...
                <a class="side-bar-link" style=" background: rgb(167,169,208)"><li id="manageArea"><div class="side-bar-image"><i class="fa-solid fa-briefcase"></i></div> <span >Manage Offers</span></li></a>
    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="add-city-container">
                <div class="heading">Add Offer</div>
                <form class="add-city-form form" action="/restaurant-dashboard/manage-offers/add-offers/add" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <textarea class="form-control"  id="offerDesc" name="offerDesc" rows="2" placeholder="Description" required></textarea>
                    </div>
                    <div class="form-group mb-5 row">
                        <div class="col">
                            <label for="startTime">Start time</label>
                            <input type="datetime-local" class="form-control" id="startTime" name="startTime" aria-describedby="emailHelp" placeholder="Start Time">
                        </div>
                        <div class="col">
                            <label for="endTime">End time</label>
                            <input type="datetime-local" class="form-control" id="endTime" name="endTime" aria-describedby="emailHelp" placeholder="End Time">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="number" class="form-control" id="offerDiscount" name="offerDiscount" placeholder="OfferPrice Discount" required>
                    </div>
