    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="city-details-data">
                ...
                <div class="m-4">
                    <a href="/restaurant-dashboard/product/add-product"><div class="btn btn-info">Add Product</div></a>
                </div>
                <div class="table">
                    <table>
                        <thead>
...
<%--                                        <a href="#" onclick="showLargePhoto('${product.photoString}')">--%>
                                            <img class="employee-img" src="data:image/png;base64,${product.photoString}" alt="Photo" />
<%--                                        </a>--%>
                                    </c:if>
                                </td>
                                <td>${product.price}</td>
                                ...
                                <td>
                                    <a href="/restaurant-dashboard/product/${product.id}/edit" class="btn" type="button" style="background: #b1b4dc">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="/restaurant-dashboard/product/${product.id}/delete" class="btn btn-danger" type="button">
