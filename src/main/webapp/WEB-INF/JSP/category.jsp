    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="city-details-data">
                ...
                <div class="m-4">
                    <a href="/admin-dashboard/add-category"><div class="btn btn-info">Add Category</div></a>
                </div>
                <div class="table">
                    <table>
                        <thead>
                        <tr>
                            ...
                            <th class="name" scope="col">Category Name</th>
                            <th class="des" scope="col">Category Description</th>
                            <th class="handle" scope="col">Action</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${x}" var="cityItem" varStatus="loop">
                            <tr>
                                <td style="padding-left: 15px;">${loop.index + 1}</td>
                                <td>${cityItem.name}</td>
                                <td>${cityItem.description}</td>
                                <td>
                                    <a href="/admin-dashboard/category/${cityItem.id}/edit" class="btn" type="button" style="background: #b1b4dc">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="/admin-dashboard/category/${cityItem.id}/delete" class="btn btn-danger" type="button">
