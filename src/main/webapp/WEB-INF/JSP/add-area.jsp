    ...
    <section class="side-bar">
        <div class="list">
            <ul>
                ...
                <a href="/admin-dashboard" class="side-bar-link"><li><div class="side-bar-image"><i class="fa-solid fa-spoon"></i></div> <span>Manage Restaurant</span></li></a>
                <a href="/admin-dashboard" class="side-bar-link"><li><div class="side-bar-image"><i class="fa-solid fa-bag-shopping"></i></div> <span >Manage Offers</span></li></a>
                <a href="/admin-dashboard" class="side-bar-link"><li><div class="side-bar-image"><i class="fa-solid fa-phone-flip"></i></div> <span >Manage Complaint</span></li></a>
    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="add-city-container">
                ...
                <form class="add-city-form form" action="/admin-dashboard/add-area/add" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-5">
                        <label for="cityId">Select City</label>
                        <select class="form-select" id="cityId" name="cityId" aria-label="Select City" required>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="text" class="form-control" id="areaName" name="areaName" aria-describedby="emailHelp" placeholder="City Name" required>
                    </div>
                    <div class="form-group mb-5">
                        <label for="areaDesc">Area Description</label>
                        <div id="">
                            <textarea class="form-control"  id="areaDesc" name="areaDesc" rows="3" placeholder="Description" required></textarea>
                        </div>
                    </div>
