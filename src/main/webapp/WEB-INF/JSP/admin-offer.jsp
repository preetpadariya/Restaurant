    ...
    <section class="side-bar">
        <div class="list">
            <ul>
                ...
                <a class="side-bar-link disabled-link" style="background: rgb(167,169,208)"><li><div class="side-bar-image"><i class="fa-solid fa-bag-shopping"></i></div> <span >Manage Offers</span></li></a>
                ...
                <div class="table">
                    <table>
                        ...
                        <tr>
                            ...
                            <th style="width: 10%" scope="col">Restaurant</th>
                        ...
                        <c:forEach items="${offer}" var="offer" varStatus="loop">
                            <tr>
                                ...
                                <td>${offer.endDate}</td>
                                <td>
                                <a href="/admin-dashboard/offers/${offer.id}/delete" class="btn btn-danger" type="button">
