    ...
    <section class="side-bar">
        <div class="list">
            <ul>
                ...
                <a class="side-bar-link disabled-link" style="background: rgb(167,169,208)"><li><div class="side-bar-image"><i class="fa-solid fa-spoon"></i></div> <span>Manage Restaurant</span></li></a>
                ...
                <div class="table">
                    <table>
                        ...
                        <tr>
                            ...
                            <th style="width: 10%" scope="col">Area</th>
                        ...
                        <tbody>
                        <c:forEach items="${restaurant}" var="restaurant" varStatus="loop">
                            <tr>
