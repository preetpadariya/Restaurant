    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="add-city-container">
                <div class="heading">Edit city</div>
                <form class="add-city-form form" action="/admin-dashboard/edit-city/${city.id}/add" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-5">
                        <label for="cityName">City Name</label>
                        <input type="text" class="form-control" id="cityName" name="cityName" aria-describedby="emailHelp" placeholder="City Name" value="${city.name}" required>
                    </div>
                    <div class="form-group mb-5">
                        <label for="cityDesc">City Description</label>
                        <div id="">
                            <textarea class="form-control"  id="cityDesc" name="cityDesc" rows="3" placeholder="Description" required>${city.description}</textarea>
                        </div>
                    </div>
