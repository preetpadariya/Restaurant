    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="city-details-data">
                ...
                <div class="m-4">
                    <a href="/restaurant-dashboard/manage-complaints/add-complaints"><div class="btn btn-info">Add Complaint</div></a>
                </div>
                <div class="table">
                    <table>
                        <thead>
                        <tr>
                            ...
                            <th style="width: 15%" scope="col">Complaint Subject</th>
                            <th style="width: 20%" scope="col">Complaint Description</th>
                            <th style="width: 15%" scope="col">Status</th>
                            <th style="width: 15%" scope="col">Reply</th>
                            <th style="width: 15%" scope="col">Complaint Date</th>
                            <th style="width: 15%" scope="col">Reply Date</th>
                        </tr>
                        </thead>
                        <tbody>
