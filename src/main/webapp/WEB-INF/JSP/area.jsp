    ...
    <section class="side-bar">
        <div class="list">
            <ul>
                ...
                <a class="side-bar-link disabled-link" style=" background: rgb(167,169,208)"><li><div class="side-bar-image"><i class="fa-solid fa-location-dot"></i></div> <span >Manage Area</span></li></a>
    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="city-details-data">
                ...
                <div class="m-4">
                    <a href="/admin-dashboard/add-area"><div class="btn btn-info">Add Area</div></a>
                </div>
                <div class="table">
                    <table id="areaTable">
                        <thead>
                        <tr>
                            ...
                            <th class="city-name" scope="col">City Name</th>
                            <th class="name" scope="col">Area Name</th>
                            <th class="des" scope="col">Area Description</th>
                        ...
                        <c:forEach items="${city}" var="cityItem" varStatus="loop">
                            <tr>
                                ...
                                <td>${cityItem.city.name}</td>
                                <td>${cityItem.name}</td>
                                <td>${cityItem.description}</td>
                                <td>
                                    <a href="/admin-dashboard/area/${cityItem.id}/edit" class="btn" type="button" style="background: #b1b4dc">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="/admin-dashboard/area/${cityItem.id}/delete" class="btn btn-danger" type="button">
...
<script>
    ...
    function generatePDF() {
        ...
        if (typeof jsPDF !== 'undefined') {
            // jsPDF is available, proceed with PDF generation
            const doc = new jsPDF();
            doc.text("Area Details", 10, 10);
            doc.autoTable({ html: '#areaTable' });
            doc.save('area_details.pdf');
        } else {
            // jsPDF is not available, show an error message
            console.error('jsPDF is not defined. Make sure the library is loaded properly.');
        }
    }
</script>
</body>
