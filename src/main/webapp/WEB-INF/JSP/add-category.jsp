    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="add-city-container">
                ...
                <form class="add-city-form form" action="/admin-dashboard/add-category/add" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-5">
                        <label for="categoryName">Category Name</label>
                        <input type="text" class="form-control" id="categoryName" name="categoryName" aria-describedby="emailHelp" placeholder="City Name" required>
                    </div>
                    <div class="form-group mb-5">
                        <label for="categoryDesc">Category Description</label>
                        <div id="">
                            <textarea class="form-control"  id="categoryDesc" name="categoryDesc" rows="3" placeholder="Description" required></textarea>
                        </div>
                    </div>
