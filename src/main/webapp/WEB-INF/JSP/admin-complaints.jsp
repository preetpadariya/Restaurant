    ...
    <section class="side-bar">
        <div class="list">
            <ul>
                ...
                <a class="side-bar-link disabled-link" style="background: rgb(167,169,208)"><li><div class="side-bar-image"><i class="fa-solid fa-phone-flip"></i></div> <span >Manage Complaint</span></li></a>
                ...
                <div class="table">
                    <table>
                        ...
                        <tr>
                            ...
                            <th style="width: 8%" scope="col">Subject</th>
                            <th style="width: 15%" scope="col">Description</th>
                            <th style="width: 7%" scope="col">Status</th>
                            <th style="width: 15%" scope="col">Reply</th>
                            <th style="width: 10%" scope="col">Complaint Date</th>
                            <th style="width: 10%" scope="col">Reply Date</th>
                            <th style="width: 7%" scope="col">Action</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${complaint}" var="complaint" varStatus="loop">
                            <tr>
                                ...
                                <td>
                                    <a href="/admin-dashboard/complaints/${complaint.id}/download" class="btn" type="button" style="background: #b1b4dc">
                                        <i class="fa-solid fa-download"></i>
                                    </a>
                                    <a href="/admin-dashboard/complaints/${complaint.id}/done" class="btn btn-success" type="button">
