    ...
    <section class="side-bar">
        <div class="list">
            <ul>
                ...
                <a class="side-bar-link disabled-link" style="background: rgb(167,169,208)"><li><div class="side-bar-image"><i class="fa-solid fa-mug-saucer"></i></div> <span >Manage Category</span></li></a>
    ...
    <div id="content">
        <div class="contentcontainer">
            <div class="add-city-container">
                ...
                <form class="add-city-form form" action="/admin-dashboard/edit-category/${category.id}/add" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-5">
                        <label for="cityName">Category Name</label>
                        <input type="text" class="form-control" id="cityName" name="cityName" aria-describedby="emailHelp" placeholder="Category Name" value="${category.name}" required>
                    </div>
                    <div class="form-group mb-5">
                        <label for="cityDesc">Category Description</label>
                        <div id="">
                            <textarea class="form-control"  id="cityDesc" name="cityDesc" rows="3" placeholder="Description" required>${category.description}</textarea>
                        </div>
                    </div>
